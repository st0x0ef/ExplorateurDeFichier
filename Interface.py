...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow, app, explorateur):
        ...
        self.label_2.setGeometry(QtCore.QRect(400, 30, 111, 31))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(parent=self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(200, 30, 111, 31))
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(parent=self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(270, 30, 111, 31))
        self.label_4.setObjectName("label_4")
        self.label_5 = QtWidgets.QLabel(parent=self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(600, 30, 111, 31))
        self.label_5.setObjectName("label_5")

        self.repertoire = QtWidgets.QLabel(parent=self.centralwidget)
        self.repertoire.setGeometry(QtCore.QRect(10, 0, 600, 31))
    ...
    def refresh(self):
        ...
        for file in fichiers:
            ...
            nom.setGeometry(QtCore.QRect(10, 10, 180, 15))
    ...
    def changer_repertoire(self):
        dialog = Dialog.Ui_Dialog(self, "changeRepertoire")
        dialog.exec()

    def renommer_element(self):
        dialog = Dialog.Ui_Dialog(self, "renommer")
        dialog.exec()
    ...
    def creer_document(self):
        dialog = Dialog.Ui_Dialog(self, "creerDocument")
        dialog.exec()

    def creer_dossier(self):
        dialog = Dialog.Ui_Dialog(self, "creerDossier")
        dialog.exec()

    def action_compresser_zip(self):
        self.explorateur.make_archive("zip")
        self.refresh()

    def action_compresser_tar(self):
        self.explorateur.make_archive("gztar")
        self.refresh()
