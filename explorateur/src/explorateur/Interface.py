...
class Ui_MainWindow(object):
    ...
    def changer_repertoire(self):
        dialog = InputDialog.Ui_InputDialog(self, "changeRepertoire")
        dialog.exec()

    def renommer_element(self):
        dialog = InputDialog.Ui_InputDialog(self, "renommer")
        dialog.exec()
    ...
    def creer_document(self):
        dialog = InputDialog.Ui_InputDialog(self, "creerDocument")
        dialog.exec()

    def creer_dossier(self):
        dialog = InputDialog.Ui_InputDialog(self, "creerDossier")
        dialog.exec()

    def erreur(self, text):
        dialog = MessageDialog.Ui_MessageDialog(text)
        dialog.exec()
